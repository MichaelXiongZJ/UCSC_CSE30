...
Original file is located at
    https://colab.research.google.com/drive/1vB3WjTu67IqIaNh33d_TR2rUdLJ_2tbb

# Overall Score

You received 65 out of 65 points.
...
* Second, download the notebook in .ipynb format (File > Download .ipynb) and upload the .ipynb file to [this form](https://docs.google.com/forms/d/e/1FAIpQLSdDCc25FusvNVcI4u6IpC_fz5H-UEO9Wdp5FIPKKGbX9z-oCQ/viewform?usp=sf_link). 
...
class CleanData(object):
    ...
    def __init__(self, discount_factor):
        ...
        """
        # YOUR CODE HERE
        self.d = DiscountedAveragerator(discount_factor)
    ...
    def filter(self, x, num_stdevs=2.):
        ...
        # YOUR CODE HERE
        self.d.add(x)
        if abs(x - self.d.avg) > abs(num_stdevs*self.d.std):
          return self.d.avg
        else:
          return x
...
class MotionDetection(object):
    ...
    def detect_motion(self, img):
        ...
        # YOUR CODE HERE
        self.d.add(img)    
        motion = abs(img - self.d.avg) > self.num_sigmas*self.d.std
        return np.max(motion, axis = 2)
