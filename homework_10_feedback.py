# -*- coding: utf-8 -*-
"""Homework_10_feedback

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1MC9KWmNYB-Y9SG5V4lBiDDoDefVcVHgU

# Overall Score

You received 40 out of 60 points.
...
### BEGIN HIDDEN TESTS
g = Graph(vertices=['a', 'b', 'c', 'd', 'e'], edges=[('a', 'b'), ('b', 'c'), ('d', 'e')])
assert not is_tree(g)
g = Graph(vertices=['a', 'b', 'c', 'd'], edges=[('a', 'b'), ('b', 'c'), ('a', 'd')])
assert is_tree(g)
g = Graph(vertices=['a', 'b', 'c', 'd'], edges=[('a', 'b'), ('b', 'c'),
                                                ('a', 'd'), ('d', 'b')])
assert not is_tree(g)
### END HIDDEN TESTS
...
g = Graph(vertices=[1])
assert is_tree(g)
g = Graph(vertices=['a', 'b', 'c', 'd'], edges=[('a', 'b'), ('b', 'c'), ('d', 'd')])
assert not is_tree(g)
g = Graph(vertices=['a', 'b', 'c', 'd'], edges=[('a', 'b'), ('b', 'c')])
assert not is_tree(g)
g = Graph(vertices=['a', 'b', 'c'], edges=[('a', 'b'), ('b', 'c'), ('c', 'a')])
assert not is_tree(g)
### END HIDDEN TESTS
...
def can_reach(v, g1, g2, w):
    ...
    for a in g2.edges:
      All_Edges.add(a)
    g3 = Graph(vertices=g1.vertices, edges=All_Edges)
    return w in reachable(g3, v)
...
### BEGIN HIDDEN TESTS
vertices = set(range(1000))
# g1 edges go from n to 5n, g2 edges go from n to 7n.
g1 = Graph(vertices=vertices, edges=[(n, 5 * n) for n in range(1000) if 5 * n < 1000])
g2 = Graph(vertices=vertices, edges=[(n, 7 * n) for n in range(1000) if 7 * n < 1000])
assert can_reach(1, g1, g2, 35)
assert can_reach(1, g1, g2, 49)
assert can_reach(1, g1, g2, 175)
assert can_reach(1, g1, g2, 625)
assert not can_reach(1, g1, g2, 312)
assert not can_reach(1, g1, g2, 400)
assert not can_reach(1, g1, g2, 24)
assert not can_reach(1, g1, g2, 32)
assert not can_reach(1, g1, g2, 70)
assert can_reach(11, g1, g2, 385)
assert can_reach(11, g1, g2, 539)
assert not can_reach(11, g1, g2, 540)
assert not can_reach(11, g1, g2, 625)
### END HIDDEN TESTS
