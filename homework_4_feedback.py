...
Original file is located at
    https://colab.research.google.com/drive/1Gth-4XGIxg1AoFYJf3-avONbtjznn_gQ

# Overall Score

You received 25 out of 25 points.
...
* Second, download the notebook in .ipynb format (File > Download .ipynb) and upload the .ipynb file to [this form](https://docs.google.com/forms/d/e/1FAIpQLSc0KrVS2PqPJwbvO0vlrNWtpGZ3xSJxHAEQtfbfXI8X8vkhpw/viewform?usp=sf_link). 
