...
Original file is located at
    https://colab.research.google.com/drive/1UN5hXjIbyGAtkQYB69YIyPx4PWh_qaj4
...
### BEGIN HIDDEN TESTS
e = ("+", ("-", ("/", "cat", 2), ("-", "dog", 3)), ("*", ("+", 3, 1), ("-", 3, ("+", "y", 1))))
assert compute(e) == ('+',
 ('-', ('/', 'cat', 2), ('-', 'dog', 3)),
 ('*', 4, ('-', 3, ('+', 'y', 1))))
assert compute(e, varval={'cat': 6}) == ('+', ('-', 3.0, ('-', 'dog', 3)), ('*', 4, ('-', 3, ('+', 'y', 1))))
assert compute(e, varval={"dog": 5}) == ('+', ('-', ('/', 'cat', 2), 2), ('*', 4, ('-', 3, ('+', 'y', 1))))
assert compute(e, varval={"dog": 5, "y": 3, "hippo": 7}) == ('+', ('-', ('/', 'cat', 2), 2), -4)
assert compute(e, varval={"dog": 5, "y": 3, "hippo": 7, "cat": 3}) == -4.5
### END HIDDEN TESTS
...
### BEGIN HIDDEN TESTS
e1 = ('*', ('*', 'a', 1), ('/', 1, 'a'))
assert value_equality(e1, 1) == True

e2 = ('/', 1, ('/', 1, ('+', 'x', 1)))
e3 = ('+', 'x', 1)
assert value_equality(e2, e3)

assert not value_equality(e1, e3)

e4 = ('/', 'cat', ('+', 'dog', ('-', 2, 'dog')))
e5 = ('/', 'cat', 2)
assert value_equality(e4, e5)
### END HIDDEN TESTS
...
# YOUR CODE HERE
print('my answer:      ', derivate(('/', 2, 'x'), 'x'))
e = ('/', ('-', ('*', 0, 'x'), ('*', 2, 1)), ('*', 'x', 'x'))

print('supposed answer:', e)
...
### BEGIN HIDDEN TESTS
assert derivate(('+', 'a', 'b'), 'b') == ('+', 0, 1)
assert derivate(('-', 4, 'd'), 'd') == ('-', 0, 1)
assert derivate(('*', 'b', 'x'), 'b') == ('+', ('*', 1, 'x'), ('*', 'b', 0))
assert derivate(('/', 'x', 'a'), 'x') == ('/', ('-', ('*', 1, 'a'), ('*', 'x', 0)), ('*', 'a', 'a'))
### END HIDDEN TESTS
