...
Original file is located at
    https://colab.research.google.com/drive/1MiOGLfChccUCMkWnnobkOOxchwaHaf0w
...
* Second, download the notebook in .ipynb format (File > Download .ipynb) and upload the .ipynb file to [this form](https://docs.google.com/forms/d/e/1FAIpQLSdZ5gdp-2RB6wdevdSYohKMA4nbLwYV8mrHJFMRnbJ_GdTS-Q/viewform?usp=sf_link). 
...
class Fraction(object):
    ...
    def __add__(self, other):
      m = self.numerator*other.denominator + other.numerator*self.denominator
      n = self.denominator*other.denominator
      return Fraction(m, n)
    ...
    def __mul__(self, other):
      m = self.numerator*other.numerator
      n = self.denominator*other.denominator
      return Fraction(m, n)
